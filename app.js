...
app.use('/frontend/user', requireAuth, express.static(path.join(frontendDirectory, 'user')));
app.use('/frontend/admin', requireAuth, requireAdmin, express.static(path.join(frontendDirectory, 'admin')));
